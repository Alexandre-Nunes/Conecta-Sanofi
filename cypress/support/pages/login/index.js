...
class Login {
    ...
    loginFarmaceuticoComRegistro() {
        ...
        cy.get(el.InputNumeroRegistro).type('12354')
        cy.get(el.InputSenha).type('123456')
        cy.get(el.ButtonEntrar).click({force: true})
        cy.get(el.ValidaLogin).should('contain', 'Doctor Four')
    ...
    loginEnfermeiroComRegistro() {
        ...
        cy.get(el.SelectEstado).select('BA')
        cy.get(el.InputNumeroRegistro).type('12333')
        cy.get(el.InputSenha).type('123456')
        cy.get(el.ButtonEntrar).click({force: true})
        cy.get(el.ValidaLogin).should('contain', 'Anderson Silva')
    ...
    loginNutricionistaComRegistro() {
        ...
        cy.get(el.SelectEstado).select('BA')
        cy.get(el.InputNumeroRegistro).type('14959')
        cy.get(el.InputSenha).type('123456')
        cy.get(el.ButtonEntrar).click({force: true})
        cy.get(el.ValidaLogin).should('contain', 'Doctor Four')
